...
public class ProductController {
    ...
    @PostMapping("/slipping")
    public Transfer uploadOnlySlip(@RequestBody Transfer transfer) {

        productService.addTransfer(transfer);
        return transfer;

    }

    @PostMapping("/slipping/image")
    public ResponseEntity<?> uploadSlipImage(@RequestParam("file") MultipartFile file) throws IOException {
        try {
